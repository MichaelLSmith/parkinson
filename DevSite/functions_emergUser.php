...
function x_breadcrumbs() {
    ...
    if ( x_get_option( 'x_breadcrumb_display' ) ) {
      ...
      echo '<div class="x-breadcrumbs"><a href="' . $home_link . '">' . $home_text . '</a>' . $delimiter;
        ...
        // custom post types
        } elseif ( is_singular( 'career-volunteer' ) ) {

            if ( $is_ltr ) {
              echo '<a href="' . get_post_type_archive_link( 'career-volunteer' ) . '">' . __( 'Career Volunteer' ) . '</a>' . $delimiter . $current_before . $page_title . $current_after;
            } else {
              echo $current_before . $page_title . $current_after . $delimiter . '<a href="' . get_post_type_archive_link( 'career-volunteer' ) . '">' . __( 'Your post type' ) . '</a>';
            }
        // custom post types

...
<div class="row equal my-5">
	<div class="col-md-6 d-flex">
		<a class="card mb-3 w-100" href="<?php echo site_url('/actualites-et-nouvelles/possibilites-deducation/'); ?>">
			<img class="card-img-top" src="<?php echo fabric()->asset_uri('img/education-seminar.jpg'); ?>" alt="" />
			<div class="card-body">
				<p class="card-text">
					<?php echo ICL_LANGUAGE_CODE === 'en' ? 'Education Opportunities' : 'Possibilités d\'éducation'; ?>
